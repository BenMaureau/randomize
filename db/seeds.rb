...
puts "=== Adding users... ==="
user1 = User.create(first_name: 'Benjamin', last_name: 'Maureau', email: 'benjamin@randomize.fun', password: 'azerty', phone_number: "0608450544", birth_date: "1997-11-15")
...
user1.save
user2 = User.create(first_name: 'Tania', last_name: 'Hajjar', email: 'tania@randomize.fun', password: 'azerty', phone_number: "0675727589", birth_date: "1997-09-21")
...
user2.save
user3 = User.create(first_name: 'Robin', last_name: 'Dahan', email: 'robin@randomize.fun', password: 'azerty', phone_number: "0661681428", birth_date: "1997-10-17")
...
user3.save
user4 = User.create(first_name: 'Louis', last_name: 'Hocquet', email: 'louis@randomize.fun', password: 'azerty', phone_number: "0786423455", birth_date: "1996-06-04")
